        ...
        <div class="use-manage">
          <div>
            ...
            <div class="car-txt">
              <div class="txt1">
                <p>未使用</p>
                <img src="https://i02piccdn.sogoucdn.com/c5e3cc096f747fc4" alt />
          ...
          <div class='mas-2 mas'>
            ...
            <el-table :data="list2.err_record" style="width: 100%,display:flex, justify-content:center" height="144">
  ...
  mounted() {
    this.axios
      ...
      .then(res => {
        ...
        this.list = res.data.car_massage;
        this.list2 = res.data;
